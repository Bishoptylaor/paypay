...
type PreLicesingProxy interface {
...
func NewPreLicesingCaller(c *aliClient.Client) PreLicesingProxy {
	// do some implantation
	caller := &PreLicesingCaller{Client: c}
	// 设置本产品相关接口默认参数校验规则
...
func (c PreLicesingCaller) InjectCustomPayloadCheckRuler(custom map[string][]paypay.Ruler) {
	if c.rulersMap == nil {
...
func (c PreLicesingCaller) payloadChecker() paypay.PayloadRuler {
...
func (c PreLicesingCaller) setDefaultPayloadCheckRuler() map[string][]paypay.Ruler {
