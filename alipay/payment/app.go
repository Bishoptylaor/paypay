...
func NewAppCaller(c *aliClient.Client) AppProxy {
	// do some implantation
	caller := &AppCaller{Client: c}
	// 设置本产品相关接口默认参数校验规则
...
func (c AppCaller) InjectCustomPayloadCheckRuler(custom map[string][]paypay.Ruler) {
	if c.rulersMap == nil {
...
func (c AppCaller) payloadChecker() paypay.PayloadRuler {
...
func (c AppCaller) setDefaultPayloadCheckRuler() map[string][]paypay.Ruler {
