...
func NewPCPageCaller(a *aliClient.Client) flow.PcPagePay {
	...
	aliClient.SetPayloadPreSetter(map[string][]alipay.PayloadPreSetter{
		"alipay.trade.page.pay": []alipay.PayloadPreSetter{
			preSetter("product_code", "FAST_INSTANT_TRADE_PAY"),
		},
	})(a)
	return a
}

func (PCPageCaller) payloadChecker() alipay.PayloadRuler {
