...
func NewAttractingTrafficPromotionCaller(c *aliClient.Client) AttractingTrafficPromotionProxy {
	// do some implantation
	caller := &AttractingTrafficPromotionCaller{Client: c}
	// 设置本产品相关接口默认参数校验规则
...
func (c AttractingTrafficPromotionCaller) InjectCustomPayloadCheckRuler(custom map[string][]paypay.Ruler) {
	if c.rulersMap == nil {
...
func (c AttractingTrafficPromotionCaller) payloadChecker() paypay.PayloadRuler {
...
func (c AttractingTrafficPromotionCaller) setDefaultPayloadCheckRuler() map[string][]paypay.Ruler {
