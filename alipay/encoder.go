...
func (encoder *Encoder) EncodeValues(buffer *bytes.Buffer, values url.Values, opts *xcrypto.SignOptions) ([]byte, error) {
	if values == nil {
		return nil, nil
	}
...
func (encoder *Encoder) EncodeBytes(buffer *bytes.Buffer, data []byte, opts *xcrypto.SignOptions) ([]byte, error) {
	if data == nil {
		return nil, nil
	}
